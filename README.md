...
|w/o pretrain| depth encoder(#para) | pose encoder(#para) | abs_rel  | sq_rel     | rmse      | rmse_log | δ<1.25   | δ<1.25^2 | δ<1.25^3 |
|------------|----------------------|---------------------|----------|------------|-----------|----------|----------|----------|----------|
| yes        | ResNet18  (11.18M)   | ResNet18  (11.18M)  | 0.132    | 1.044      | 5.142     | 0.210    | 0.845    | 0.948    | 0.977    |
| yes        | ResNeSt26 (15.02M)   | ResNet18  (11.18M)  | 0.127    | 1.005      | 5.051     | 0.205    | 0.856    | 0.950    | 0.978    |<!--18-->
| yes        | ResNeSt26 (15.02M)   | ResNeSt26 (15.02M)  | **0.124**| **0.947**  | **4.987** | **0.203**| **0.858**| **0.952**| **0.979**|<!--15-->
